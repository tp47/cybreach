...
3. Выполните команду `npm run dev:client` чтобы запустить только клиент
4. Выполните команду `npm run dev:server` чтобы запустить только server

II) Запуск через Yarn:
